...
namespace Asaurus
{
	Shader::Shader(const std::string& vertexSrc, const std::string& fragmentSrc)
	{
		...
		if (isCompiled == GL_FALSE)
		{
			...
			AS_CORE_ERROR("Vertex shader compilation error:");
			AS_CORE_ERROR("\t{0}", infoLog.data());
			AS_CORE_ASSERT(false, "Vertex shader compilation error!");
		...
		if (isCompiled == GL_FALSE)
		{
			...
			// Info logging
			AS_CORE_ERROR("Fragment shader compilation error:");
			AS_CORE_ERROR("\t{0}", infoLog.data());
			AS_CORE_ASSERT(false, "Fragment shader compilation error!");
